...
public class StorageNode {
    ...
    public static void main(String[] args) throws Exception {
        ...
        KeyValueService.Processor<KeyValueService.Iface> processor = new KeyValueService.Processor<>(new KeyValueHandler(host, port, curClient, zknode));
        ...
        curClient.getChildren()
                .usingWatcher(new CuratorWatcher() {
                    ...
                    public void process(WatchedEvent watchedEvent) throws Exception {
                        // list of servers changed
                        // read through and determine if this is the primary or backup
