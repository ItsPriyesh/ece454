...
public class A3FatClient implements CuratorWatcher {
    static Logger log;
    ...
    public static void main(String[] args) throws Exception {
        ...
        log = Logger.getLogger(A3FatClient.class.getName());

        A3FatClient client = new A3FatClient(args[0], args[1], Integer.parseInt(args[2]), Integer.parseInt(args[3]), Integer.parseInt(args[4]));
//
//        try {
//            client.start();
//            client.execute();
...
//        }
        client.start();
        client.getPrimary();
        KeyValueService.Client thriftClient = client.getThriftClient();
    ...
    A3FatClient(String zkConnectString, String zkNode, int numThreads, int numSeconds, int keySpaceSize) {
